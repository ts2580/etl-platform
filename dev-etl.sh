...
DEBUG_ENV_KEYS=(APP_DB_ENABLED DB_URL DB_USERNAME DB_PASSWORD ROUTING_APP_PORT FILE_APP_PORT SALESFORCE_CLIENT_ID SALESFORCE_CLIENT_SECRET SALESFORCE_REDIRECT_URI SALESFORCE_AUTH_URL SALESFORCE_TOKEN_URL SALESFORCE_ALLOWED_ORIGINS SALESFORCE_LOGIN_URL SALESFORCE_API_VERSION SALESFORCE_INSTANCE_URL REDIS_URL REDIS_PORT REDIS_PASSWORD)
