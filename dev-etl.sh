...
DEBUG_ENV_KEYS=(APP_DB_ENABLED DB_URL DB_USERNAME DB_PASSWORD MAIN_APP_PORT ROUTING_APP_PORT FILE_APP_PORT ALB_URI SALESFORCE_CLIENT_ID SALESFORCE_CLIENT_SECRET SALESFORCE_REDIRECT_URI SALESFORCE_AUTH_URL SALESFORCE_TOKEN_URL SALESFORCE_MY_DOMAIN)
