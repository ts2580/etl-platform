package com.sfdcupload.health.controller;
...
public class HealthController {
    ...
    public ResponseEntity<HealthStatusResponse> health() {
        ...
        return ResponseEntity.ok(new HealthStatusResponse("etl-file-engine", "UP", dbEnabled, salesforceConfigured, Instant.now()));
    }
}
